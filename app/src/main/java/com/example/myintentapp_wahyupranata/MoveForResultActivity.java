...
public static int RESULT_CODE = 110;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChose = (Button)findViewById(R.id.btn_chose);
        btnChose.setOnClickListener(this);
        rgNumber = (RadioGroup)findViewById(R.id.rg_number)
    }
    @Override
    public void onClick(View v){
        if (v.getId() == R.id.btn_chose){
            if (rgNumber.getCheckedRadioButtonId() != 0){
                int value = 0;
                switch (rgNumber.getCheckedRadioButtonId()){
                    case R.id.rb_50 : value =50;
                    break;
                    case R.id.rb_100 : value =100;
                        break;
                    case R.id.rb_150 : value =150;
                        break;
                    case R.id.rb_200 : value =200;
                        break;
                }
